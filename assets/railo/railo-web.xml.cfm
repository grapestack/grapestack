...
<railo-configuration password="ebde04b793bee5aebf0171fb9f4239da39ea1b2857c43d771b08bafd62df37f1" version="2.0">
  <cfabort/>
...
<!--	or ask your database distributor 																-->
	...
	<data-sources>
	<data-source allow="511" blob="false" class="org.gjt.mm.mysql.Driver" clob="false" connectionLimit="-1" connectionTimeout="1" custom="characterEncoding=UTF-8&amp;useUnicode=true" database="grape" dsn="jdbc:mysql://{host}:{port}/{database}" host="localhost" metaCacheTimeout="60000" name="grape" password="encrypted:e669bfa78e0c611c55f82a2e3f3a3b50e61b86247a9fadd318780dce1206b02d" port="3306" storage="false" username="grape" validate="false"/>
	</data-sources>
	...
	directory mapping:
		...
		<mapping physical="/grape/sites/coldbox/" primary="physical" toplevel="true" trusted="false" virtual="/coldbox"/>
	</mappings>	
...
<gateways>
  ...
  <gateway cfc-path="WEB-INF.railo.gateway.railo.extension.gateway.default" class="" custom="listenerFunction=onReady&amp;interval=500" id="test" listener-cfc-path="WEB-INF.railo.gateway.railo.extension.gateway.defaultListener" read-only="false" startup-mode="manual"/>
